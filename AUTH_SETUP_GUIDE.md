...
1. [功能說明](#功能說明)
2. [準備工作](#準備工作)
3. [步驟一：創建 Google Sheets](#步驟一創建-google-sheets)
4. [步驟二：打開 Apps Script 編輯器](#步驟二打開-apps-script-編輯器)
5. [步驟三：複製認證代碼](#步驟三複製認證代碼)
6. [步驟四：初始化用戶系統](#步驟四初始化用戶系統)
7. [步驟五：部署為網頁應用程式](#步驟五部署為網頁應用程式)
8. [步驟六：在網站中設置 URL](#步驟六在網站中設置-url)
9. [管理用戶帳號](#管理用戶帳號)
10. [常見問題](#常見問題)
...
### Q2: 部署後訪問 URL 顯示「Script function not found: doGet」？

**解決方法：**
- 確認代碼已正確複製，包含 `doGet` 函數
- 保存代碼後重新部署
